...
use rmk_types::protocol::rynk::{
    ...
    GetMorseProfileBulkResponse, KeyPosition, LayerState, LightingCapabilities, LightingCompiledSceneStatus,
    ...
    MatrixState, PeripheralStatus, PointingConfig, ProtocolVersion,
    ...
    SetMorseProfileBulkRequest, SetMorseProfileRequest, SetMorseRequest, SetPointingConfigRequest,
