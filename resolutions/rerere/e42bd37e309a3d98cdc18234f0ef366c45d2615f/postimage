...
impl<'a> RynkService<'a> {
    ...
    fn requires_maintenance_mode(cmd: Cmd) -> bool {
        match cmd {
            ...
            | Cmd::AbortLightingAdvancedRuntimeConditionalSceneReplace => true,
            _ => false,
        }
    }
    ...
    async fn dispatch(
        ...
        match cmd {
            ...
            Cmd::GetLayerState => serve::<command::GetLayerState, _>(self, msg).await,
            Cmd::GetModifierState => serve::<command::GetModifierState, _>(self, msg).await,
