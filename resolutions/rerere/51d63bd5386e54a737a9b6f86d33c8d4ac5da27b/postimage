...
use rmk_types::protocol::rynk::{
    ...
    GetComboDefinitionBulkResponse, GetKeymapBulkResponse, GetMorseBulkResponse, PeripheralStatus, ProtocolVersion,
    SetComboBulkRequest, SetComboDefinitionBulkRequest, SetKeymapBulkRequest, SetMorseBulkRequest,
};
